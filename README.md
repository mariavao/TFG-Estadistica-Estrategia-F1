...
| [`codigo.R`](./codigo.R) | Notebook con el código y el análisis (programado en R) |
...
*Este repositorio se publica con fines académicos y de portfolio profesional. Si quieres reutilizar parte del contenido, ponte en contacto conmigo.*
